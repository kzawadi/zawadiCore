...
class ZawadiTagTextInput extends StatefulWidget {
  ...
  @override
  _ZawadiTagTextInputState createState() => _ZawadiTagTextInputState();
}

class _ZawadiTagTextInputState extends State<ZawadiTagTextInput> {
